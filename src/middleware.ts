...
const publicRoutes = ["/", "/about", "/contact", "/buscar-viaje", "/politica-de-privacidad", "/terminos-y-condiciones", "/eliminacion-de-datos", "/sobre-nosotros", "/centro-de-ayuda", "/blog-de-viaje", "/faq", "/auth/error"];
