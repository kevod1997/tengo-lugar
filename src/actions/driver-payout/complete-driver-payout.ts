 ...
 * 3. Create a TransferProof record
...
export async function completeDriverPayout(
  ...
  throw ServerActionError.ValidationFailed(
    ...
    'Incluirá carga de comprobante de transferencia a S3, creación de TransferProof, ' +
