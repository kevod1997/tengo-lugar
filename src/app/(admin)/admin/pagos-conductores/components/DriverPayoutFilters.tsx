...
export function DriverPayoutFilters() {
  ...
  const updateFilters = (newStatus?: string, newSearch?: string) => {
    ...
    const finalStatus = newStatus !== undefined ? newStatus : status
    ...
    router.push(`/admin/pagos-conductores?${params.toString()}`)
  }
      ...
      <div className="flex-1">
        <div className="flex gap-2">
          <div className="relative flex-1">
            <Input
              placeholder="Buscar por nombre del conductor, email o ID de viaje..."
              value={searchTerm}
