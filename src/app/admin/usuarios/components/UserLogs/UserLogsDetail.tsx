...
export function UserLogsView({ userId }: UserLogsViewProps) {
    ...
    useEffect(() => {
      fetchLogs()
    }, [userId, pagination.currentPage, pagination.pageSize, filters]) // Added pagination.pageSize and filters to dependencies
          ...
          <div className="space-y-4">
            <div className="flex flex-wrap gap-4">
              ...
              >
                ...
                <SelectContent>
                  <SelectItem value="all">Todas las acciones</SelectItem> {/* Changed value to "all" */}
