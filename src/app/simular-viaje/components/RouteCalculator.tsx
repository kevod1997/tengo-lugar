...
import { generateTimeOptions } from '@/utils/helpers/generateTimeOptions'
            ...
            {routeInfo && routeInfo.routes && routeInfo.routes.length > 0 && (
                <>
                    ...
                    <TravelCostCalculator
                        routeInfo={routeInfo}
                        fuels={fuels}
                        onPriceChange={() => setCalculatedPrice(calculatedPrice)}
                        onCarChange={(carId) => setSelectedCar(carId)}
                    />
                        ...
                        <div className="mt-6 flex justify-end">
                            ...
                            >
                                {isLoading ? (
                                    ...
                                    `Crear viaje por $${calculatedPrice.priceGuide.toFixed(2)}`
                                )}
                            </Button>
                        </div>
                    )}
