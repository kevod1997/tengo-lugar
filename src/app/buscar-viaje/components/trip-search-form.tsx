...
//         router.push(`/buscar-viaje?${params.toString()}`)
//     }
...
//                             className="h-12 pl-10 pr-4 rounded-md border-muted"
//                         />
...
//                     {/* Switch button */}
//                     <div className="relative flex justify-center -my-2 md:my-0 md:-mx-2 z-10">
//                         <Button
//                             type="button"
//                             size="icon"
//                             variant="outline"
...
//                             <Button
//                                 variant="outline"
//                                 className="w-full h-12 px-3 text-left font-normal justify-start border-muted"
//                             >
...
//                             className="h-12 w-full rounded-md border border-muted bg-background px-3 py-2"
//                         >
//                             {[1, 2, 3, 4].map(num => (
        ...
        <Card className={cn("shadow-lg", className)}>
            <CardContent className="pt-6">
                <form onSubmit={handleSubmit}>
                    ...
                    {/* Optional: Small helper text to indicate required fields */}
